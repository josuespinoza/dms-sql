...
'Clase para manejo de controles de la pantalla de reporte de cuotas vencidas del modulo de financiamiento

Partial Public Class CuotasVencidas : Implements IFormularioSBO, IUsaMenu
    ...
    Public ButtonImprimirCuotasVenc As ButtonSBO
    ...
    'Inicializa controles de pantalla de reporte de cuotas vencidas
    ...
    Public Sub InicializarControles() Implements IFormularioSBO.InicializarControles
        ...
        ButtonImprimirCuotasVenc = New ButtonSBO("btnImpVenc", FormularioSBO)
    ...
    'Manejo de eventos de pantalla de reporte de cuotas vencidas
    ...
    Public Sub ApplicationSBOOnItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        ...
        If pVal.EventType = BoEventTypes.et_ITEM_PRESSED Then
            Select Case pVal.ItemUID
                Case ButtonImprimirCuotasVenc.UniqueId
                    ButtonSBOImprimirCuotasVencItemPresed(FormUID, pVal, BubbleEvent)
