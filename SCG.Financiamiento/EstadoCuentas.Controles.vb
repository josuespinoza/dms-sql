...
'Clase para manejar controles del formulario de reporte de estado de cuentas del modulo de financiamiento

Partial Public Class EstadoCuentas : Implements IFormularioSBO, IUsaMenu
    ...
    Public ButtonImprimirEstado As ButtonSBO
    ...
    'Inicializa controles de pantalla de reporte de estado de cuentas
    ...
    Public Sub InicializarControles() Implements IFormularioSBO.InicializarControles
        ...
        ButtonImprimirEstado = New ButtonSBO("btnImpEst", FormularioSBO)
    ...
    'Manejo de eventos de la pantalla de reporte de estado de cuentas
    ...
    Public Sub ApplicationSBOOnItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        ...
        If pVal.EventType = BoEventTypes.et_ITEM_PRESSED Then
            Select Case pVal.ItemUID
                Case ButtonImprimirEstado.UniqueId
                    ButtonSBOImprimirEstadoItemPresed(FormUID, pVal, BubbleEvent)
