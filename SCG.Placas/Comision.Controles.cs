...
{
    partial class Comision : IFormularioSBO , IUsaMenu 
    {
        public Comision(Application applicationSBO, ICompany companySBO)
        {
        ...
        private EditTextSBO EditTextFechaInicio;
        private EditTextSBO  EditTextfechaFinal;
        ...
        public void InicializarControles()
        {
            if (FormularioSBO != null)
            {
                ...
                userDataSources.Add("fechaInic", BoDataType.dt_DATE, 100);
                userDataSources.Add("fechaFin", BoDataType.dt_DATE, 100);


                EditTextFechaInicio = new EditTextSBO("txtFchIni", true, "", "fechaInic", FormularioSBO);
                EditTextFechaInicio.AsignaBinding();

                EditTextfechaFinal = new EditTextSBO("txtFchFin", true, "", "fechaFin",FormularioSBO);
                EditTextfechaFinal.AsignaBinding();
