...
Module ConstructorDisponibilidadEmpleados

    ''' <summary>
    ''' Crea una nueva instancia del formulario disponibilidad de empleados
    ''' puede ser utilizado varias veces, es decir se pueden abrir varias ventanas del formulario
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub CrearInstanciaFormulario()
        ...
        Try
            ...
            'oFormCreationParams.FormType = "SCGD_OTCP"
            strRutaXML = My.Resources.Resource.XMLDisponibilidadEmpleados
            ...
            ControladorDisponibilidadEmpleados.CargarValoresPredeterminados(oFormulario)
    ...
    ''' <summary>
    ''' Agrega el formulario al menú de SAP bajo el menú padre "Citas"
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub AgregarMenu()
        Dim strMenuPadre As String = "SCGD_CITS"
        Dim strTitulo As String = My.Resources.Resource.MenuDisponibilidadEmpleados
        Dim strIDMenu As String = "SCGD_DAPE"
        Dim intPosicion As Integer = 6

        Try
            'Verifica que el usuario tenga permisos para accesar al formulario
            'Disponibilidad agenda por empleados
            If DMS_Connector.Helpers.PermisosMenu("SCGD_DAPE") Then
