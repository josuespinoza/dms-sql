...
Public Class MatrizLineasDimensiones : Inherits MatrixSBO
    ...
    Public Overrides Sub CreaColumnas()
        ...
        _columnaMarca = New ColumnaMatrixSBOEditText(Of String)("colMar", True, "U_CodMar", Me)
        _columnaDescripcion = New ColumnaMatrixSBOEditText(Of String)("colDes", True, "U_DesMar", Me)
