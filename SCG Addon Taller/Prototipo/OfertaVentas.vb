...
Public Class OfertaVentas:  Implements IFormularioSBO, IUsaMenu
    ...
    Public Sub New(ByVal p_application As Application,
        ...
        NombreXml = Windows.Forms.Application.StartupPath + My.Resources.Resource.XMLFormularioOfertaVentas
        MenuPadre = "SCGD_PRO"
        Nombre = "Cotización"
        IdMenu = "SCGD_COT"
        Titulo = "Cotización"
