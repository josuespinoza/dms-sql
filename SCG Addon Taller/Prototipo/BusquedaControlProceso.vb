...
Public Class BusquedaControlProceso: Implements IFormularioSBO, IUsaMenu
    ...
    Public Sub New(ByVal p_application As Application,
        ...
        NombreXml = Windows.Forms.Application.StartupPath + My.Resources.Resource.XMLFormularioBusquedaControlProceso
        MenuPadre = "SCGD_PRO"
        Nombre = "Busqueda Control Proceso"
        IdMenu = "SCGD_BCP"
        Titulo = "Busqueda Control Proceso"
        Posicion = 2
        FormType = "SCGD_BCP"
    End Sub
