...
Public Class ControlCrearVisita: Implements IFormularioSBO, IUsaMenu
    ...
    Public Sub New(ByVal p_application As Application,
        ...
        NombreXml = Windows.Forms.Application.StartupPath + My.Resources.Resource.XMLFormularioControlCrearVisita
        MenuPadre = "SCGD_PRO"
        Nombre = "Control Crear Visita"
        IdMenu = "SCGD_CCV"
        Titulo = "Control Crear Visita"
        Posicion = 3
        FormType = "SCGD_CCV"
    End Sub
