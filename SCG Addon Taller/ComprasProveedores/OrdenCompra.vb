...
Module OrdenCompra
    ...
    Public Sub ValidarEliminarLinea(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean, ByVal NumeroFila As Integer)
        ...
        Try
            ...
            If Formulario.TypeEx = "142" AndAlso NumeroFila >= 0 Then
                NumeroOrdenTrabajo = Formulario.DataSources.DBDataSources.Item("OPOR").GetValue("U_SCGD_Numero_OT", 0).Trim()
                DocType = Formulario.DataSources.DBDataSources.Item("OPOR").GetValue("DocType", 0).Trim()
    ...
    Private Sub GuardarEstadoPrevioLineas(ByVal FormUID As String, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If Formulario.Mode <> SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                DocumentoCompra = DMS_Connector.Company.CompanySBO.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oPurchaseOrders)
                DocEntry = Formulario.DataSources.DBDataSources.Item("OPOR").GetValue("DocEntry", 0).ToString().Trim()
            ...
            For i As Integer = 0 To DocumentoCompra.Lines.Count - 1
                ...
                If ListaCantidadesAbiertas.ContainsKey(IDActividad) AndAlso DocumentoCompra.Lines.LineStatus <> SAPbobsCOM.BoStatus.bost_Open Then
                    ...
                    If NumeroLineaOferta >= 0 Then
                        ...
                        CalculoCantidades.RecalcularCantidades(SAPbobsCOM.BoObjectTypes.oPurchaseOrders, TipoMovimiento.Cierre, False, OfertaVentas.Lines.Quantity, CantidadAbiertaDocumentoCompra, CantidadSolicitada, CantidadPendiente, CantidadRecibida)
