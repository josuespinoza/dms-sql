...
Public Class ConfiguracionInterfazTSD : Implements IFormularioSBO, IUsaPermisos
...
#Region "Declaraciones"
    Private Const tablaConfig = "@SCGD_TSD_CONF"
...
#Region "Constructor"
    ...
    Public Sub New(ByVal application As SAPbouiCOM.Application, ByVal companySbo As ICompany, ByVal mc_strUISCGD_ConfTSDInterface As String)
        _companySbo = companySbo
        _applicationSbo = application
        NombreXml = System.Windows.Forms.Application.StartupPath & My.Resources.Resource.XMLFormInterfazTSD
        MenuPadre = "SCGD_CFG"
        Nombre = My.Resources.Resource.MenuConfTIC
        IdMenu = mc_strUISCGD_ConfTSDInterface
        Titulo = My.Resources.Resource.MenuConfTIC
        Posicion = 78
        FormType = mc_strUISCGD_ConfTSDInterface
    End Sub
