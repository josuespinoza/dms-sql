...
Partial Public Class BodegaProceso : Implements IFormularioSBO, IUsaMenu
...
#Region "Métodos"
    ...
    Public Sub New(ByVal ocompany As SAPbobsCOM.Company, _
                   ByVal SBOAplication As Application, p_menuInformesDMS As String, p_strUID_FORM_BodegasP As String)

        m_oCompany = ocompany
        m_SBO_Application = SBOAplication
        m_strDireccionConfiguracion = CatchingEvents.DireccionConfiguracion
        NombreXml = Windows.Forms.Application.StartupPath + My.Resources.Resource.XMLFormularioReporteBodega
        MenuPadre = p_menuInformesDMS
        Nombre = My.Resources.Resource.MenuReporteBodegas
        IdMenu = p_strUID_FORM_BodegasP
        Titulo = My.Resources.Resource.MenuReporteBodegas
        Posicion = 5
        FormType = p_strUID_FORM_BodegasP
