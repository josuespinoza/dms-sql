...
Public Class FactutacionOTInternas : Implements IUsaMenu, IFormularioSBO, IUsaPermisos
...
#Region "Contructor"
    ...
    Public Sub New(ByVal ocompany As SAPbobsCOM.Company, _
                   ByVal SBOAplication As Application, ByVal p_menuInformesDMS As String, ByVal p_strUID_FORM_ReporteFacturacionInterna As String)
        m_oCompany = ocompany
        m_SBO_Application = SBOAplication
        NombreXml = Windows.Forms.Application.StartupPath + My.Resources.Resource.XMLFormularioReporteFacturacionOTInterna
        MenuPadre = p_menuInformesDMS
        Nombre = My.Resources.Resource.MenuReporteFacturacionOrdenesTrabajo
        IdMenu = p_strUID_FORM_ReporteFacturacionInterna
        Titulo = My.Resources.Resource.MenuReporteFacturacionOrdenesTrabajo
        Posicion = 10
        FormType = p_strUID_FORM_ReporteFacturacionInterna
    End Sub
#End Region
...
#Region "Metodos"
    ...
    Private Sub CargarMatrixTipo()
        ...
        table.ExecuteQuery(" SELECT 'N' as sel, Name as des, Code as cod FROM [@SCGD_TIPO_ORDEN] WHERE U_Interna = 'Y' ")
    ...
    Public Sub CargarParametros(ByVal formUID As String, ByVal pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        ...
        parametros = String.Format(" {0},{1},( {2} ),( {3} )", fechaF, fechaI, WhereSucursales, WhereTiposOT)

        If _rbtnResumido.ObtieneValorUserDataSource = "Y" Then
            Call Print(My.Resources.Resource.rptFacturacionInternaResumido & ".rpt", My.Resources.Resource.TituloRPFacturacionInternaResumido, parametros)
        Else
            Call Print(My.Resources.Resource.rptFacturacionInternaDetallado & ".rpt", My.Resources.Resource.TituloRPFacturacionInternaDetallado, parametros)
        End If
        ...
        Select Case pVal.ItemUID
            ...
            Case _chbDate.UniqueId
                ...
                Else
                    ...
                    If DateTime.Now.Month.ToString.Length = 1 Then fechaF = fechaF & "0" & DateTime.Now.Month Else fechaF = fechaF & DateTime.Now.Month
                    If DateTime.Now.Day.ToString.Length = 1 Then fechaF = fechaF & "0" & DateTime.Now.Day Else fechaF = fechaF & DateTime.Now.Day
                    _txtDateS.AsignaValorUserDataSource(fechaF)
