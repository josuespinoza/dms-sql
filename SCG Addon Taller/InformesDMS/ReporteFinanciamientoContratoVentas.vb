...
Public Class ReporteFinanciamientoContratoVentas : Implements IUsaMenu, IFormularioSBO, IUsaPermisos
...
#Region "Variables"
    ...
    Private _company_Sbo As SAPbobsCOM.ICompany
...
#Region "Contructor"
    ...
    Public Sub New(ByVal ocompany As SAPbobsCOM.Company, _
        ...
        NombreXml = Windows.Forms.Application.StartupPath + My.Resources.Resource.XMLFormularioReporteFinanciamientoContratoVentas
        MenuPadre = "SCGD_IND"
        Nombre = My.Resources.Resource.TituloRPTFinanciamientoCV
        IdMenu = "SCGD_RFC"
        Titulo = My.Resources.Resource.TituloRPTFinanciamientoCV
        Posicion = 12
        FormType = "SCGD_RFC"
...
#Region "Metodos"
    ...
    Public Sub CargarParametros(ByVal formUID As String, ByVal pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        ...
        parametros = String.Format(" {0},{1}", fechaF, fechaI)
        
        Call Print(My.Resources.Resource.rptFinanciamientoCV & ".rpt", My.Resources.Resource.TituloRPTFinanciamientoCV, parametros)
