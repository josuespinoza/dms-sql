...
Public Class ListadoContratosFacturadosReversadosCls
...
#Region "Declaraciones"
    ...
    Private Const mc_strUIDListaR As String = "SCGD_LCR"
...
#Region "Metodos"
    ...
    Protected Friend Sub AddMenuItems()
        ...
        If Utilitarios.MostrarMenu("SCGD_LCR", SBO_Application.Company.UserName) Then
            strEtiquetaMenu = Utilitarios.PermisosMenu("SCGD_LCR", SBO_Application.Language)
    ...
    Protected Friend Sub CargaFormularioListadoCV()
        ...
        Try
            ...
            'fcp.FormType = "SCGD_ListaARevertir"

            'strXMLACargar = "ListadoContratosReversados.xml"
            strXMLACargar = My.Resources.Resource.ListaContratosFacturadosARevertir
            fcp.XmlData = CargarDesdeXML(strXMLACargar)
            fcp.FormType = "SCGD_frmListadoAReversar"
            ...
            Call CargarValidValuesEnCombos(m_oFormGenCotizacion, "SELECT top 1 U_Prio, U_Estado FROM [@SCGD_ADMIN9] ORDER BY  U_Prio Desc", "cboEstado")
        ...
        Try
            ...
            If Not oForm Is Nothing _
                ...
                If Not oMatrix Is Nothing Then
                    ...
                    Call CargarMatrix(DirectCast(oForm.Items.Item("mtListadoR").Specific, SAPbouiCOM.Matrix), _
    ...
    End Sub
    Private Function DevolverNivelFacturado() As Integer
        ...
        Dim StrConsulta As String = "Select Max(U_Nivel) from [@SCGD_NIVELES_PV]"
        Dim intNumPago As Integer = CType(Utilitarios.EjecutarConsulta(StrConsulta, baseDatos, Server), Integer)
    ...
    Public Function CargarMatrix(ByRef oMatrix As SAPbouiCOM.Matrix, _
        ...
        Try
            ...
            oCondition.CondVal = CodEstado 'DevolverNivelFacturado()
    ...
    Public Function DevolverIDContrato(ByVal p_intRow As Integer, ByVal p_strIDForm As String) As String
        ...
        oMatriz = DirectCast(SBO_Application.Forms.Item("SCGD_frmListadoAReversar").Items.Item("mtListadoR").Specific, SAPbouiCOM.Matrix)
    ...
    Protected Friend Sub CargarValidValuesEnCombos(ByRef oForm As SAPbouiCOM.Form, ByVal strQuery As String, ByRef strIDItem As String)
